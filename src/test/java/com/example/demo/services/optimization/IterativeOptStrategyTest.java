...
//
//public class IterativeOptStrategyTest {
//
//
//    final IterativeOptStrategy<Room> classUnderTest = new IterativeOptStrategy<>();
//
//
//
//
...
//        Assert.assertEquals(classUnderTest.optimize(10, 3, 2), new Room(2, 2, 10, 4));
